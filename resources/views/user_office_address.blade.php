							...
							<div class="uofb cf">
								<div class="l_col adrs">
									...
									<form action="{{route('store')}}" method="POST">
										...
										<div class="field">
											<label>Name *</label>
											<input type="text" name="name" value="" placeholder="" class="vl_empty" />
                                            @if ($errors->has('name'))
										...
										<div class="field">
                                            ...
                                            @if ($errors->has('area'))
                                                <span>{{ $errors->first('area') }}</span>
                                            @endif
										</div>

										<div class="field">
											<label>Street</label>
											<input type="text" name="street" value="" placeholder="" class="vl_empty" />
